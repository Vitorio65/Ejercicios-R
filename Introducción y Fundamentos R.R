...
#Enunciado: Crea un vector edades con las edades de tres personas y una lista llamda informacion con el nombre y la edad de una persona.

edades <- c(17, 38, 18)

informacion <- list(nombre = "Luis", edad = 25)
...
#Enunciado: Verifica si nombre es de tipo caracter y si #numero es de tipo #lógico.
